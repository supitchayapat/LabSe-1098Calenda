...
public class JDayChooser extends JPanel implements ActionListener, KeyListener,
    ...
    public JDayChooser(boolean weekOfYearVisible) {
        ...
        sundayForeground = new Color(200, 0, 0);
        weekdayForeground = new Color(10, 20, 140);

        // decorationBackgroundColor = new Color(194, 211, 252);
        // decorationBackgroundColor = new Color(206, 219, 246);
        decorationBackgroundColor = new Color(21, 198, 138);
        ...
        for (int y = 0; y < 7; y++) {
            for (int x = 0; x < 7; x++) {
                ...
                days[index].setMargin(new Insets(40, 40, 40, 40));
        ...
        for (int i = 0; i < 7; i++) {
            ...
            weeks[i].setMargin(new Insets(40, 40, 40, 40));
            weeks[i].setFocusPainted(false);
            weeks[i].setBackground(decorationBackgroundColor);
            weeks[i].setForeground(new Color(70, 100, 100));
    ...
    protected void init() {
        ...
        selectedColor = new Color(170, 255, 0);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        setDay(day);
        JTextEvents events = new JTextEvents();
