...
import components.JLocaleChooser;
import components.JSpinField;
import components.JTitlePanel;
...
public class JCalendarDemo extends JApplet implements PropertyChangeListener {
    ...
    public static void main(String[] s) {
        ...
        JFrame frame = new JFrame("SupItchaya Project Ku.");
        ...
        frame.pack();
        frame.setBounds(1000, 1500, (int) frame.getPreferredSize().getWidth(),
                    ...
                    if (propertyDescriptors[i].getWriteMethod() != null) {
                        ...
                        if (type.equals(types[t]) &&
                            ...
                            if ("boolean".equals(type)) {
                                ...
                                localeChooser.setPreferredSize(new Dimension(900,
